  ...
  public: {
    Tables: {
      ...
      fee_audit_log: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ["fee_record_id"]
            isOneToOne: false
            referencedRelation: "v_fee_grid_consolidated"
            referencedColumns: ["pyd_fee_record_id"]
          },
          {
            foreignKeyName: "fk_audit_fee_record"
            columns: ["fee_record_id"]
            isOneToOne: false
            referencedRelation: "v_fee_grid_consolidated"
            referencedColumns: ["tuition_fee_record_id"]
          },
          {
            foreignKeyName: "fk_audit_fee_record"
            columns: ["fee_record_id"]
      ...
      student_archive_audit: {
        ...
        Relationships: [
          {
            foreignKeyName: "student_archive_audit_student_id_fkey"
            columns: ["student_id"]
            isOneToOne: false
            referencedRelation: "students"
            referencedColumns: ["id"]
    ...
    Views: {
      ...
      v_fee_grid: {
        Row: {
          ...
          previous_year_dues: number | null
          section: string | null
          status: string | null
      ...
      v_fee_grid_consolidated: {
        Row: {
          ...
          final_fee: number | null
          has_pyd: boolean | null
          has_tuition: boolean | null
          paid_amount: number | null
          previous_year_dues: number | null
          pyd_fee_record_id: string | null
          status: string | null
          student_id: string | null
          tuition_fee_record_id: string | null
          updated_at: string | null
        }
        Relationships: []
      }
