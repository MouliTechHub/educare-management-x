-- ============================================================================
-- A) Database: canonical views, unique guard, and cleanup (Fixed)
-- ============================================================================
...
-- 5. Recompute balance safely for all rows
...
-- 6. Update summary RPC to use canonical views and add priority buckets
