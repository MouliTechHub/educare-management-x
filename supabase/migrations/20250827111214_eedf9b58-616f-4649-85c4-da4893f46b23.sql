...
-- 3) Handle status column type conversion by dropping dependent views first
DO $$
BEGIN
  ...
  IF EXISTS (
    ...
    DROP VIEW IF EXISTS public.class_gender_stats;
    ...
    -- Recreate the class_gender_stats view
